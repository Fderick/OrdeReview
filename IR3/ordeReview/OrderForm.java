...
public class OrderForm {
	...
	private int diam,layer,type,frosting,topping;
	...
	public OrderForm(int diam, int layer, String type, String frosting, String topping1, String topping2, String topping3, String specialInstruc, 
			String first, String last, String email,int orderNumber) {
		initialize(diam,layer,type,frosting,topping1,topping2,topping3,specialInstruc,first,last,email,orderNumber);
	}
	public void initialize(int diam, int layer, String type, String frosting, String topping1, String topping2, String topping3, String specialInstruc, 
		...
		CakeReviewTab reviewTab = new CakeReviewTab(panel_4, infoTab, cakeTab, frostingTab, toppingsTab, frame, specialInstruc, first, last, email, orderNumber);
