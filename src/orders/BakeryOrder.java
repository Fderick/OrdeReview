...
public class BakeryOrder implements Orderable {
	...
	public BakeryOrder(int orderNumber, String firstName, String lastName, String cakeFlavor,
			String cakeFrosting, int cakeDiam, int cakeLayer, String toppings, String specialRequest, String email) {
...
//			fileMan.rewriteFile(orderNumber,this.writeDetails());
	...
	public String toString() {
		String newLine = " \r\n ";
		return firstName + " " + lastName + newLine + cakeFlavor + newLine + cakeFrosting + newLine + cakeDiam + newLine + cakeLayer + newLine + toppings + newLine + specialRequest ;
	}
